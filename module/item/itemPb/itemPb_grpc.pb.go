...
type ItemGrpcServiceClient interface {
	FindItemsInIds(ctx context.Context, in *FindItemInIdsReq, opts ...grpc.CallOption) (*FindItemInIdsRes, error)
}
...
func (c *itemGrpcServiceClient) FindItemsInIds(ctx context.Context, in *FindItemInIdsReq, opts ...grpc.CallOption) (*FindItemInIdsRes, error) {
...
type ItemGrpcServiceServer interface {
	FindItemsInIds(context.Context, *FindItemInIdsReq) (*FindItemInIdsRes, error)
...
func (UnimplementedItemGrpcServiceServer) FindItemsInIds(context.Context, *FindItemInIdsReq) (*FindItemInIdsRes, error) {
...
func _ItemGrpcService_FindItemsInIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ItemGrpcServiceServer).FindItemsInIds(ctx, req.(*FindItemInIdsReq))
	}
